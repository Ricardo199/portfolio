            ...
            <div className="App bg-dark text-light">
                <header className="App-header">
                    <Container>
                        ...
                        <img src={image} alt="Ricardo Burgos" className="d-block mx-auto my-4" style={{ width: '150px', borderRadius: '50%' }} />
                        ...
                        <button className="btn btn-primary m-3" onClick={() => window.open('https://drive.google.com/file/d/1Z9aJsbmif0kqwzmMtdhU1XPQxBgIQSXR/view?usp=sharing', '_blank')}>My CV</button>
                        <br />
                    </Container>
                </header>
            </div>
